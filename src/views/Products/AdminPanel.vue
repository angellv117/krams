            ...
            <table id="search-tableLabs" class="min-w-full text-sm text-left text-gray-500 ">
                ...
                <tbody>
                    <tr v-for="producto in productos" class="bg-white border-b  hover:bg-gray-50 ">
                        <th scope="row"
                            class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-pre-line">
                        ...
                        <td>
                            <div class="flex flex-col md:flex-row justify-center items-center ">
                                <router-link :to="{ name: 'EditProduct', params: { id: producto.id } }" type="button"
                                    class="bg-indigo-800 hover:bg-indigo-600 text-white px-4 py-2 mx-2 rounded-md">
                                ...
                                <button @click="eliminarProducto(producto.id)" type="button"
                                    class="bg-red-500 text-white px-4 py-2 mx-2 rounded-md">
        ...
        eliminarProducto(id) {
            swal.fire({
                ...
                if (result.isConfirmed) {
                    await this.$store.dispatch('deleteProducto', {
                        productoId: id
                    });
                    ...
                    if (status) {
                        ...
                        this.logout();
                        this.$router.push('/administracionKrams');
                    }
