<template>
<div class="w-full my-4 max-w-sm bg-white border border-gray-200 rounded-lg shadow  hover:scale-105 transition-all duration-300">
    <a>
        <img :class="classImage" :src="image" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a>
            <h5 class="text-xl mb-2 font-bold tracking-tight text-gray-900 ">{{ title }}</h5>
        </a>
        ...
        <div v-if="price != ''">
            <div class="flex items-center justify-between">
                ...
                <router-link :to="{ name: 'ViewProduct', params: { id: id } }" class="flex items-center justify-center gap-2 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
